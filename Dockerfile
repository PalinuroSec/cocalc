...
RUN apt-get update; apt-get -y install codium dbeaver-ce avogadro emacs krita gimp scilab sqlitebrowser mysql-workbench gmysqlcc; rm -rf /var/lib/apt/lists/*
